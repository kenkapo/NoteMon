...
const ep = () => {
  return (
    <>
      <div
        className="flex items-center justify-center min-h-screen bg-indigo-500  bg-fixed bg-cover bg-bottom error-bg nightwind-prevent"
        style={{
          backgroundImage:
        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
              ...
              <p className="text-black mt-2 mb-6 text-lg">
                <b><i>We are sorry, but the page you requested was not found!</i></b>
              </p>
              <Link to="/">
